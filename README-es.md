...
<div align="center">
  ...
  <p>Funciona en Windows y macOS.</p>
</div>

> **Versión para Windows disponible.** Descarga `adb-on-windows-x64.zip` desde Releases, descomprímelo y abre `adb-on.exe`. La conexión con un teléfono real se ha verificado por USB y Wi-Fi. Las compilaciones para macOS (Apple Silicon e Intel) también están disponibles en Releases, firmadas con Developer ID y notarizadas.
...
|---|---|---|
|Windows x64|`adb-on.exe`|Disponible. Verificados con teléfonos reales: conexión por USB y Wi-Fi, emparejamiento con código y conexión inalámbrica simultánea de dos teléfonos.|
...
- El ejecutable de Windows no tiene firma de código, por lo que SmartScreen puede mostrar una advertencia la primera vez que lo ejecutes. La aplicación no omite automáticamente las advertencias del sistema operativo ni modifica la configuración de seguridad.
